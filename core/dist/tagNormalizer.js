...
exports.HARD_ALIASES = exports.STOP_WORDS = void 0;
exports.localNormalize = localNormalize;
exports.normalizeTagList = normalizeTagList;
exports.applyAliasMapping = applyAliasMapping;
exports.normalizeAndApplyAliases = normalizeAndApplyAliases;
exports.detectAliasCycles = detectAliasCycles;
exports.removeAliasCycles = removeAliasCycles;
/**
...
function localNormalize(tag) {
    ...
    if (exports.STOP_WORDS.has(normalized)) {
        return null;
    }
    // Step 5: Apply hard aliases
    if (exports.HARD_ALIASES[normalized]) {
        normalized = exports.HARD_ALIASES[normalized];
    }
 ...
 */
function applyAliasMapping(tag, aliases) {
 ...
 */
function normalizeAndApplyAliases(tags, aliases) {
    const seen = new Set();
    const result = [];
    for (const tag of tags) {
        const normalized = localNormalize(tag);
 ...
 */
function detectAliasCycles(aliases) {
    const cycles = [];
 ...
 */
function removeAliasCycles(aliases) {
