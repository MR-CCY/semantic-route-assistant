...
const DEFAULT_SYSTEM_PROMPT = "你是一个代码审查助手，支持多种语言。" +
    "根据给定的函数签名和实现，返回 JSON：{brief, tags}。" +
    "brief 为一句话功能描述（不超过 50 个字），准确、不幻想；tags 为 1-10 个短标签，" +
    "全小写字母/数字/下划线。标签为包含中英文标签，tags 必须是\"高信息量语义标签\"，避免文件路径/模块名/类名/函数名拆词，" +
